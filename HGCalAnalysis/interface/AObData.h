...
public:
 ...
 AGenPart(): eta(-1000.),phi(-1000.),pt(-1000.),energy(-1000.),dvx(0.),dvy(0.),dvz(0.),fbrem(-1.),pid(0),gen(-1),reachedEE(-1)
  ...
  eta(i_eta),phi(i_phi),pt(i_pt),energy(i_energy),dvx(i_dvx),dvy(i_dvy),dvz(i_dvz),fbrem(i_fbrem),pid(i_pid),gen(i_gen),
    reachedEE(i_reachedEE),fromBeamPipe(i_fromBeamPipe)
  {
  }
